...
RegisterNetEvent('animations:client:SmokePurpleStank', function()
  SmokingWeed = true
  Citizen.CreateThread(function()
    while SmokingWeed do
      Citizen.Wait(Config.JointReliefInterval * 1000)
...
RegisterNetEvent('animations:client:SmokeLSConfidential', function()
  SmokingWeed = true
  Citizen.CreateThread(function()
    while SmokingWeed do
      Citizen.Wait(Config.JointReliefInterval * 1000)
...
RegisterNetEvent('animations:client:SmokeLSStrawberryBanana', function()
  SmokingWeed = true
  Citizen.CreateThread(function()
    while SmokingWeed do
      Citizen.Wait(Config.JointReliefInterval * 1000)
